...
// Usiamo real_escape_string per sicurezza contro SQL Injection
$search = isset($_GET['search']) ? $conn->real_escape_string($_GET['search']) : '';
$materia_filter = isset($_GET['materia']) ? $conn->real_escape_string($_GET['materia']) : '';

// 2. COSTRUZIONE QUERY DINAMICA
// Recuperiamo nome e cognome del venditore per poterli cercare e mostrare
...
// MODIFICA: La ricerca ora controlla Titolo, Autore, Nome o Cognome del venditore
if ($search != '') {
...
<head>
    ...
    <style>
        ...
        .seller-link { color: #888; text-decoration: none; font-size: 0.85rem; transition: 0.2s; }
...
<body>
    ...
    <div class="container">
        ...
        <form method="GET" action="compra.php" class="filter-section">
            <input type="text" name="search" placeholder="Titolo, autore o nome venditore..." value="<?php echo htmlspecialchars($search); ?>">
            ...
            <?php if($search != '' || $materia_filter != ''): ?>
                <a href="compra.php" style="color:red; text-decoration:none; font-size:0.8rem; margin-left: 10px;">Resetta filtri</a>
            <?php endif; ?>
        </form>
        ...
        <div class="market-grid">
                    ...
                    <div class="book-card">
                        ...
                        <p style="margin-top:10px;">
                            <a href="profilo.php?id=<?php echo $row['IdVenditore']; ?>" class="seller-link">
                                ...
                                <?php echo htmlspecialchars($row['nome_venditore'] . " " . $row['cognome_venditore']); ?>
                            </a>
                        </p>
            ...
            <?php else: ?>
                <div style="grid-column: 1/-1; text-align:center; padding:50px;">
                    ...
                    <p style="margin-top:20px; color:#777;">Nessun libro trovato. Prova a cambiare i termini di ricerca.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
