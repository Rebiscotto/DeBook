...
<head>
    ...
    <style>
        ...
        .chat-main.waiting-room { background: #e9ecef !important; } 
        .chat-main.active-chat { background: #fdf6ec !important; }
        ...
        .btn-feedback:hover { background: #ffeeba; }
        ...
        .msg { max-width: 75%; padding: 10px 15px; border-radius: 15px; font-size: 0.95rem; box-shadow: 0 2px 5px rgba(0,0,0,0.05); }
        ...
        .chat-footer input[type="text"] { flex: 1; padding: 12px 15px; border-radius: 25px; border: 1px solid #ddd; outline: none; font-size: 16px; }
        .btn-send { background: #333; color: #fff; border: none; width: 42px; height: 42px; border-radius: 50%; cursor: pointer; display: flex; align-items: center; justify-content: center; }

        .btn-back-chat { cursor: pointer; font-size: 1.2rem; display: none; }

        @media (max-width: 768px) {
            .chat-sidebar, .chat-main { width: 100%; }
            <?php if (!$chat_con): ?>
        ...
        <div class="chat-sidebar">
            ...
            <div class="conversations-list">
                <?php if($lista_chat->num_rows > 0): ?>
                    ...
                    <?php endwhile; ?>
                <?php else: ?>
                    <p style="padding:40px 20px; color:#999; text-align:center;">Nessuna conversazione.</p>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="chat-main <?php echo $interlocutore ? 'active-chat' : 'waiting-room'; ?>">
            <?php if ($interlocutore): ?>
                <div class="chat-header">
                    ...
                    <div style="flex: 1; display: flex; align-items: center; justify-content: space-between;">
                        ...
                        <a href="lascia_feedback.php?id_venditore=<?php echo $chat_con; ?>" class="btn-feedback">
            ...
            <?php else: ?>
                <div style="flex:1; display:flex; flex-direction:column; align-items:center; justify-content:center; padding: 20px;">
                    <i class="fa-solid fa-comments" style="font-size:4rem; color:#adb5bd; margin-bottom:15px;"></i>
                    <h2 style="color:#495057; margin:0;">Le tue conversazioni</h2>
                    <p style="color:#6c757d; margin-top: 10px;">Seleziona una chat per iniziare a messaggiare.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
